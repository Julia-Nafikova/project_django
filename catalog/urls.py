...
from catalog.views import HomeTemplateView, ProductDetailsView, ProductListView, contacts, ProductCreateView, ProductUpdateView, ProductDeleteView, UnpublishProductView
